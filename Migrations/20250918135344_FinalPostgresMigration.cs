        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnavailabilityReason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    UnavailableUntil = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UnavailabilityType = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 12, "Main conference room with projector and video conferencing", true, "2nd Floor", "Conference Room A", null, null, null },
                    { 2, 4, "Toyota Corolla - Blue", true, "Parking Bay 1", "Company Vehicle", null, null, null }
                });
